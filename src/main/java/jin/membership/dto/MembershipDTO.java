...
public class MembershipDTO {
    ...
    private LocalDateTime payment_date; // 추가
	...
	public String toString() {
		return "MembershipDTO [user_id=" + user_id + ", membership_grade=" + membership_grade + ", payment_method="
				+ payment_method + ", payment_price=" + payment_price + "]";
	}
